    ...
    def get(self):
        ...
        Returns:
            [dict]: {
                ...
                'candle-interval-choices': [A list of numbers where each number indicates the total amount of candles to use in the algorithm when calculating average price],
        ...
        return jsonify({
            ...
            'candle-interval-choices': [i for i in range(0, 1000)],
