...
class OrdersModel(db.Model):
    ...
    profit_1_target = db.Column(db.Float, default=0.0)
    profit_2_target = db.Column(db.Float, default=0.0)
    profit_3_target = db.Column(db.Float, default=0.0)
    profit_4_target = db.Column(db.Float, default=0.0)
