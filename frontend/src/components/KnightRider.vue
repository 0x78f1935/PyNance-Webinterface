<template>
    <b-container fluid>
        ...
        <b-row style="justify-content: center">
            <div :class="$vuetify.theme.dark ? 'txt-div-dark' : 'txt-div-light'">
                <span :class="$vuetify.theme.dark ? 'txtspan dark' : 'txtspan light'">{{ $store.getters.chatterer }}</span>
            </div>
        </b-row>
    </b-container>
</template>
...
.txt::before {
    // content: 'Knight Rider';
    position: absolute;
    mix-blend-mode: difference;
    filter: blur(3px);
}

.knightrider-wrapper-dark, .knightrider-wrapper-light {
    // display: inline-flex;
