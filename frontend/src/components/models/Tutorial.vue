    ...
    function initialState (){
        return {
            ...
            tutorial_data: [
                ...
                {"number": 4, "description": "This percentage is the guarentee profit margin the bot uses before the bot sells its coins."},
                {"number": 5, "description": "You can use this button to toggle the bot on/off."},
                {"number": 6, "description": "Before changing the settings, you need to unlock the settings by using this button. Changes have immidiate effect."},
