...
<spam style="color:red">When you start the bot for the first time Check yourself for a good entry in the binance app. This is important since each configuration can have different results</span>
